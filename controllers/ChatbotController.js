//import { create, findAll, count, findByPk, update, destroy, Chatbot } from '../models/Chatbot.js';
import Chatbot from '../models/Chatbot.js';
import { Op } from 'sequelize';

// Create a new chatbot for a user
export async function createChatbotForUser(req, res) {
    try {
...
export async function listChatbotsForUser(req, res) {
    try {
...
export async function retrieveChatbot(req, res) {
    try {
...
export const searchChatbots = async (req, res) => {
    try {
